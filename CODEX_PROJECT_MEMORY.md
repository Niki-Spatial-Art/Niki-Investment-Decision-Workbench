...
- `tools/portfolio_sleeve_backtest.py` and `watchlists/portfolio_sleeve_backtest.json` implement a public research-only layered portfolio experiment. It separates deep/swing/shallow holding rhythms and a benchmark-MA20 cash gate, then reports H1 2026, YTD, recent three-year, and available five-year outcomes. It is not a live allocation or execution engine.
